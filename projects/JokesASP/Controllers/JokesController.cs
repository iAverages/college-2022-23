...
namespace JokesASP.Controllers {
    public class JokesController : Controller {
        ...
        // POST: Jokes/ViewSearch
        public async Task<IActionResult> ViewSearch(String search) {
            return View("Index", await _context.Joke.Where(j => j.question.Contains(search)).ToListAsync());
        }
